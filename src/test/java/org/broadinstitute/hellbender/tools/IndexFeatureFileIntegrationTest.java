...
public final class IndexFeatureFileIntegrationTest extends CommandLineProgramTest {
    ...
    public void testIndexNonFeatureFileGZ() {
        final File ORIG_FILE = new File(getToolTestDataDir(), "test_nonFeature_file.txt.gz");
        final File outName = BaseTest.createTempFile("test_nonFeature_file.txt.", ".idx");
    ...
    public void testIndexBCFFileGZ() {
        final File ORIG_FILE = new File(getToolTestDataDir(), "test_variants_for_index.bcf.gz");
        final File outName = BaseTest.createTempFile("test_variants_for_index.bcf.gz.", ".idx");
    ...
    public void testVCFGZIndex() {
        final File ORIG_FILE = new File(getToolTestDataDir(), "test_variants_for_index.vcf.gz");
        final File outName = BaseTest.createTempFile("test_variants_for_index.", ".idx");
    ...
    public void testVCFGZIPIndex() throws IOException {
        ...
        final File ORIG_FILE = new File(getToolTestDataDir(), "test_variants_for_index.vcf.gzip");
        final File outName = BaseTest.createTempFile("test_variants_for_index.gzip", ".idx");
        final String[] args = new String[]{
                "--feature_file" ,  ORIG_FILE.getAbsolutePath(),
                "-O" ,  outName.getAbsolutePath()
        };
    ...
    public void testCompressedBCF2_2Index() {
        final File ORIG_FILE = new File(getToolTestDataDir(), "test_variants_for_index.BCF22compressed.bcf.gz");
        final File outName = BaseTest.createTempFile("test_variants_for_index.BCF22compressed.bcf.gz", ".idx");
