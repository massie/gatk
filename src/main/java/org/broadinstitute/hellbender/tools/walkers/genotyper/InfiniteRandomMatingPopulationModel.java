 ...
 * <p>
 *     Consequently genotypes between samples are totally independent conditional to their frequencies in
 *     the population they come from. And genotypes should exhibit the ratios expected under HWE.
 * </p>
 * Therefore each sample's genotype likelihoods can be considered to
