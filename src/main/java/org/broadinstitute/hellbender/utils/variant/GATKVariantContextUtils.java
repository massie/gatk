...
public final class GATKVariantContextUtils {
    ...
    public static final double SUM_GL_THRESH_NOCALL = MathUtils.log10ToLog(-0.1); // if sum(gl) is bigger than this threshold, we treat GL's as non-informative and will force a no-call.
